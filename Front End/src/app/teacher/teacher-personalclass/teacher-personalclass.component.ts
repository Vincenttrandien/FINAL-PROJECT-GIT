...
import { TeacherPersonalclassService } from './teacher-personalclass.service';

@Component({
  selector: 'app-teacher-personalclass',
  templateUrl: './teacher-personalclass.component.html',
  styleUrls: ['./teacher-personalclass.component.css']
})
export class TeacherPersonalclassComponent implements OnInit {

  constructor(private formBuilder: FormBuilder,
    private modalService: NgbModal,
    private toaster: ToastrService,
    private personalSerivce: TeacherPersonalclassService,
...
maxSize = 5;
pageSize = 10;
searchKey = this.globalMemor.currentCodeClass;
