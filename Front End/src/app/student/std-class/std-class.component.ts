...
import { StdClassService } from './std-class.service';

@Component({
  selector: 'app-std-class',
  templateUrl: './std-class.component.html',
  styleUrls: ['./std-class.component.css']
})
export class StdClassComponent implements OnInit {

  constructor(private formBuilder: FormBuilder,
    private modalService: NgbModal,
    private toaster: ToastrService,
    private personalSerivce: StdClassService,
...
dataa: any
  ...
  ngOnInit(): void {
    ...
    console.log(this.globalMemor.currentCodeClass)
