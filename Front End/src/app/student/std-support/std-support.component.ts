...
import { StdSupportService } from './std-support.service';

@Component({
  selector: 'app-std-support',
  templateUrl: './std-support.component.html',
  styleUrls: ['./std-support.component.css']
})
export class StdSupportComponent implements OnInit {

  constructor(private supportService: StdSupportService,
